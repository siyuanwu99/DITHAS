...
class DBSCANCluster {
 public:
  ...
  void setCorePointMinPts(int core_point_min_pts) { minPts_ = core_point_min_pts; }
 ...
 protected:
  ...
  virtual int radiusSearch(int                 index,
                           double              radius,
...
template <typename PointT>
class DBSCANKdtreeCluster : public DBSCANCluster<PointT> {
 protected:
  virtual int radiusSearch(int                 index,
                           double              radius,
                           std::vector<int>   &k_indices,
